...
var routerInstance = new Router({
    routes: [
        ...
        { url: 'sie',       params: { page: 'sie' } },
        { url: 'sie/upload',params: { page: 'sie-upload' } },
        { url: 'sie/browse',params: { page: 'sie-browse' } },
        { url: 'sie/browse/{id}',params: { page: 'sie-browse' } },
        { url: 'sie/totals',params: { page: 'sie-totals' } },
