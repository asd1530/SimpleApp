...
namespace Common.Sie
{
    ...
    public class SieDocument
    {
        ...
        public SieDocument(Company _company, SieFileImport _import)
        {
      ...
      public void ReadFileDocument(string fileName)
        {
            ...
            StreamReader reader = File.OpenText(this._fileName);
        ...
        private void parseENHET(SieDataItem di)
        {
            ...
            {
                KONTO.Add(di.GetString(0), new SieAccount() { Number = di.GetString(0) , Company = this.Company, Import = this.Import});
            }
        ...
        private void parseIB(SieDataItem di)
        {
            ...
            {
                KONTO.Add(di.GetString(1), new SieAccount() { Number = di.GetString(1) , Company = this.Company, Import = this.Import});
            }
        ...
        private void parseKONTO(SieDataItem di)
        {
            ...
            {
                KONTO.Add(di.GetString(0), new SieAccount() { Number = di.GetString(0), Name = di.GetString(1), Company = this.Company, Import = this.Import });
            }
        }
        ...
        private SiePeriodValue parsePBUDGET_PSALDO(SieDataItem di)
        {
            ...
            {
                KONTO.Add(di.GetString(2), new SieAccount() { Number = di.GetString(2) , Company = this.Company, Import = this.Import});
            }
